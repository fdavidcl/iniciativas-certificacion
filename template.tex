...
% Use smaller size for monospace font
\usepackage{letltxmacro}
\LetLtxMacro{\oldtt}{\texttt}
\renewcommand{\texttt}[1]{\small\oldtt{#1}\normalsize}
...
\setkeys{Gin}{width=0.4\maxwidth,height=0.4\maxheight,keepaspectratio}
$endif$

% Allow hyphens breaking URLs in footnotes
